...
namespace DTT.MinigameBase.Timer
{
    ...
    public class CustomTimerUI : MonoBehaviour
    {
        public TimeSpan maxGameTimer;
        ...
        private IEnumerator UpdateTimer()
        {
            ...
            while (enabled)
            {
                ...
                if ((maxGameTimer - _timer.TimePassed).TotalSeconds > 0) {
                    _text.text = (maxGameTimer - _timer.TimePassed).ToString("mm':'ss") ;
                }
                else
                {
                    _text.text = "00:00";
